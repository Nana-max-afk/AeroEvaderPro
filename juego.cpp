...
Juego::Juego(int ancho, int alto)
    : anchoPantalla(ancho), altoPantalla(alto), puntaje(0), vidas(3), nivel(1), jugadorX(ancho / 2), jugadorY(alto - 3),
      juegoActivo(false), velocidadGeneral(175), combustible(100), combo(0), tiempoMilisegundos(0), escudoActivo(false),
      duracionEscudo(0), turboActivo(false), duracionTurbo(0), cantidadEscudos(0), cantidadTurbos(0),
...
void Juego::iniciar(const std::string &nombreJugador) {
    ...
    while (juegoActivo) {
        ...
        auto delta = std::chrono::duration_cast<std::chrono::milliseconds>(ahora - ultimoTiempo).count();
        int actualVelocidad = turboActivo ? std::max(20, velocidadGeneral - 30) : velocidadGeneral;
...
void Juego::mostrarPantallaInicio() const {
    ...
    if (espacioPiloto < 0) espacioPiloto = 0;
    std::cout << pad << "\x1B[96m║ \x1B[97m" << pilotoLinea << std::string(espacioPiloto, ' ') << "\x1B[93mMISION: ARENA ESPACIAL \x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m╠══════════════════════════════════════════════════════════════════════════════════╣\n" << cn;

    // Nave pixel art en la pantalla de inicio
    std::cout << pad << "\x1B[96m║\x1B[0m" << "                               \x1B[91m▲\x1B[0m                                              " << "\x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m║\x1B[0m" << "                             \x1B[37m/\x1B[96m█\x1B[37m\\\x1B[0m                                             " << "\x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m║\x1B[0m" << "                \x1B[91m◄\x1B[37m══\x1B[90m█\x1B[94m██\x1B[96m█\x1B[94m██\x1B[90m█\x1B[37m══\x1B[91m►\x1B[0m                                           " << "\x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m║\x1B[0m" << "                      \x1B[90m█\x1B[91m▒\x1B[93m▓\x1B[91m▒\x1B[90m█\x1B[0m                                              " << "\x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m╠══════════════════════════════════════════════════════════════════════════════════╣\n" << cn;

    // Info de controles en 2 columnas
    std::cout << pad << "\x1B[96m║ \x1B[90m← →\x1B[37m Mover nave    \x1B[90mS\x1B[37m Activar Escudo    \x1B[90mT\x1B[37m Activar Turbo    \x1B[90mESC\x1B[37m Salir         \x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m║ \x1B[96m[C]\x1B[37m Cometa → puntos+combustible   \x1B[96m[S]\x1B[37m Escudo → protección   \x1B[96m[T]\x1B[37m Turbo → velocidad  \x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m╠══════════════════════════════════════════════════════════════════════════════════╣\n" << cn;
    std::cout << pad << "\x1B[96m║\x1B[0m" << "            \x1B[93m★\x1B[0m  Preparando sistemas de vuelo. Despegue inminente...  \x1B[93m★\x1B[0m           " << "\x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m╚══════════════════════════════════════════════════════════════════════════════════╝\n" << cn;
}
...
void Juego::mostrarPantallaCarga() const {
    ...
    std::cout << pad << "\x1B[96m╔══════════════════════════════════════════════════════════════════════════════════╗\n" << cn;
    std::cout << pad << "\x1B[96m║\x1B[0m" << "                      \x1B[93m INICIALIZANDO HIPERESPACIO \x1B[0m                          " << "\x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m╠══════════════════════════════════════════════════════════════════════════════════╣\n" << cn;
    std::cout << pad << "\x1B[96m║\x1B[0m" << "          \x1B[90m·  ★  ·  ·  ·   *   ·  ·   *   ·  ·  ·   ★  ·  ·  *  ·  ·  ·  ★  ·\x1B[0m          " << "\x1B[96m║\n" << cn;
    ...
    std::cout << pad << "\x1B[96m║\x1B[0m" << "          \x1B[90m·  ★  ·  ·  ·   *   ·  ·   *   ·  ·  ·   ★  ·  ·  *  ·  ·  ·  ★  ·\x1B[0m          " << "\x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m╠══════════════════════════════════════════════════════════════════════════════════╣\n" << cn;
    std::cout << pad << "\x1B[96m║\x1B[0m" << "         \x1B[92m✓\x1B[37m Motores encendidos    \x1B[92m✓\x1B[37m Escudos calibrados    \x1B[92m✓\x1B[37m Rumbo establecido   \x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m╚══════════════════════════════════════════════════════════════════════════════════╝\n" << cn;
...
void Juego::inicializarEstrellas() {
    ...
    for (int i = 0; i < 70; ++i) {
        Estrella estrella{distrX(generador), distrY(generador), distrCapa(generador)};
...
void Juego::dibujarEstrellas(std::vector<std::vector<Pixel>> &pantalla) const {
    for (const auto &estrella : estrellas) {
        if (estrella.y >= 0 && estrella.y < altoPantalla && estrella.x >= 0 && estrella.x < anchoPantalla) {
            std::string brillo = ".";
...
void Juego::dibujarJugador(std::vector<std::vector<Pixel>> &pantalla) const {
    ...
    if (escudoActivo) {
        ...
        for (int dx = -7; dx <= 7; ++dx) {
            ...
            if (x >= 0 && x < anchoPantalla && yBottom >= 0 && yBottom < altoPantalla) {
    ...
    auto dibujaNavePixel = [&](int rx, int ry, const std::string &caracter, const std::string &color) {
        int x = jugadorX + rx;
        int y = jugadorY + ry;
...
void Juego::dibujarObstaculo(std::vector<std::vector<Pixel>> &pantalla, const Obstaculo &obs) const {
    auto dibujaPixel = [&](int rx, int ry, const std::string &caracter, const std::string &color) {
        int x = obs.x + rx;
        int y = obs.y + ry;
        if (x >= 0 && x < anchoPantalla && y >= 0 && y < altoPantalla) {
            pantalla[y][x].caracter = caracter;
...
void Juego::dibujarEscena() const {
    ...
    std::vector<std::vector<Pixel>> pantalla(altoPantalla, std::vector<Pixel>(anchoPantalla));
    ...
    std::string salida;
    // Reservar espacio suficiente para los caracteres de la pantalla más los códigos ANSI de color
    ...
    salida += margenStr + colorMarco + "║" + colorNormal + std::string(relleno / 2, ' ') + "\x1B[93m" + lineaTitulo + colorNormal + std::string(relleno - relleno / 2, ' ') + colorMarco + "║\n" + colorNormal;
    salida += margenStr + colorMarco + "╠" + std::string(anchoPantalla, '═') + "╣\n" + colorNormal;

    std::string leyenda = " [M] Asteroide   [C] Cometa   [D] Drone   [S] Escudo   [T] Turbo ";
    if ((int)leyenda.size() < anchoPantalla) {
        leyenda += std::string(anchoPantalla - (int)leyenda.size(), ' ');
    }
    salida += margenStr + colorMarco + "║" + "\x1B[37m" + leyenda.substr(0, anchoPantalla) + colorMarco + "║\n" + colorNormal;

    // Barra de notificación de eventos en juego
    if (!mensajeNotificacion.empty() && timerNotificacion > 0) {
        // Calcular ancho visible aproximado del mensaje sin códigos ANSI (aproximado)
        // El mensaje ya incluye padding de 2 espacios por lado
        std::string notifLinea = mensajeNotificacion;
        // Centrar el mensaje dentro del ancho del campo
        int anchoVisible = 0;
        bool enCodigo = false;
        for (char c : notifLinea) {
            if (c == '\x1B') { enCodigo = true; continue; }
            if (enCodigo) { if (c == 'm') enCodigo = false; continue; }
            anchoVisible++;
        }
        int paddingLeft = std::max(0, (anchoPantalla - anchoVisible) / 2);
        int paddingRight = std::max(0, anchoPantalla - anchoVisible - paddingLeft);
        std::string notifFila = std::string(paddingLeft, ' ') + notifLinea + std::string(paddingRight, ' ');
        salida += margenStr + colorMarco + "║" + "\x1B[40m" + notifFila.substr(0, notifFila.size()) + colorMarco + "║\n" + colorNormal;
    } else {
...
void Juego::mostrarBarraEstado(std::string &salida) const {
    ...
    int espacio1 = anchoPantalla - (int)pilotoTxt.size() - (int)nivelTxt.size() - 2;
    if (espacio1 < 0) espacio1 = 0;
    salida += margenStr + colorMarco + "║ " + colorNormal 
              + "\x1B[97m" + pilotoTxt + colorNormal 
              + std::string(espacio1, ' ') 
              + "\x1B[93m" + nivelTxt + colorNormal 
              + colorMarco + " ║\n" + colorNormal;
    ...
    if (espacio2 < 0) espacio2 = 0;

    salida += margenStr + colorMarco + "║ " + colorNormal
              + "\x1B[92m" + puntajeTxt + colorNormal
              + std::string(espacio2, ' ')
              + "\x1B[91m" + corazones + colorNormal
              + colorMarco + " ║\n" + colorNormal;

    // Linea 3: Combustible (barra gráfica) y Tiempo
    int celdasActivas = std::min(15, (combustible * 15) / 140);
    if (celdasActivas < 0) celdasActivas = 0;
    ...
    std::string bar;
    for (int i = 0; i < 15; ++i) {
        if (i < celdasActivas) bar += "█";
        else bar += "░";
    }
    
    std::string combustibleTexto = "⛽ " + std::to_string(combustible) + "% ";
    std::string tiempoTxt = "Tiempo: " + std::to_string(tiempoMilisegundos / 1000) + "s ";
    
    int visibleCombustibleLen = 14 + 15 + 1 + combustibleTexto.size(); // Largo de la barra
    int espacio3 = anchoPantalla - visibleCombustibleLen - (int)tiempoTxt.size() - 2;
    if (espacio3 < 0) espacio3 = 0;

    salida += margenStr + colorMarco + "║" + colorNormal
              + colorCombustible + combustibleBarra + bar + "] " + combustibleTexto + colorNormal
              + std::string(espacio3, ' ')
              + "\x1B[95m" + tiempoTxt + colorNormal
              + colorMarco + " ║\n" + colorNormal;

    // Linea 4: Inventario de Powerups y Estados activos
    int espacio4 = anchoPantalla - 53; // Espaciado fijo calculado para calzar exactamente con el ancho
    if (espacio4 < 0) espacio4 = 0;

    salida += margenStr + colorMarco + "║" + colorNormal
              + "\x1B[96m" + " [S] Escudos: " + std::to_string(cantidadEscudos) + " (" + (escudoActivo ? "\x1B[96mACTIVO" : "\x1B[90mLISTO") + "\x1B[96m)" + colorNormal
              + std::string(espacio4, ' ')
              + "\x1B[93m" + " [T] Turbos: " + std::to_string(cantidadTurbos) + " (" + (turboActivo ? "\x1B[93mACTIVO" : "\x1B[90mLISTO") + "\x1B[93m) " + colorNormal
              + colorMarco + "║\n" + colorNormal;

    // Linea 5: Controles de ayuda
    std::string controles = " Controles: <- / ->  |  S = ACTIVAR ESCUDO  |  T = ACTIVAR TURBO  |  ESC = SALIR ";
    int espacio5 = anchoPantalla - (int)controles.size();
    if (espacio5 < 0) espacio5 = 0;
    salida += margenStr + colorMarco + "║" + colorGris + controles + std::string(espacio5, ' ') + colorMarco + "║\n" + colorNormal;
    salida += margenStr + colorMarco + "╚" + std::string(anchoPantalla, '═') + "╝\n" + colorNormal;
}

void Juego::procesarEntrada() {
    const int radioNave = 6; // Modificado para evitar el recorte visual de las alas en los límites izquierdo/derecho
    while (_kbhit()) {
        int tecla = _getch();
...
void Juego::generarObstaculos() {
    ...
    if (chance < umbral) {
        ...
        // Limitar la coordenada de spawn x según el ancho del obstáculo para evitar salirse de los límites
        if (chance < 4) {
            tipo = TipoObstaculo::PowerUpEscudo;
            minX = 2; maxX = anchoPantalla - 3; // Ancho 5
        } else if (chance < 8) {
            tipo = TipoObstaculo::PowerUpTurbo;
            minX = 2; maxX = anchoPantalla - 3; // Ancho 5
        } else if (chance < 24) {
            tipo = TipoObstaculo::Cometa;
            minX = 4; maxX = anchoPantalla - 3; // Ancho 7
        } else if (chance < 50) {
            tipo = TipoObstaculo::Drone;
            minX = 3; maxX = anchoPantalla - 4; // Ancho 7
        } else {
            tipo = TipoObstaculo::Meteoro;
            minX = 1; maxX = anchoPantalla - 2; // Ancho 3
        }
...
void Juego::actualizarEscena() {
    ...
    obstaculos.erase(std::remove_if(obstaculos.begin(), obstaculos.end(), [&](const Obstaculo &obs) {
        if (obs.y > altoPantalla - 1) {
            if (obs.tipo == TipoObstaculo::Meteoro || obs.tipo == TipoObstaculo::Drone) {
                puntaje += 15;
            } else if (obs.tipo == TipoObstaculo::Cometa) {
                puntaje += 12;
            }
            return true;
        }
            ...
            switch (it->tipo) {
                ...
                case TipoObstaculo::Drone:
                    if (escudoActivo) {
                        ...
                        duracionEscudo = 0;
                        puntaje += 10;
                        mensajeNotificacion = "  \x1B[96m★ ESCUDO ABSORBE EL IMPACTO! +10 ★\x1B[0m  ";
                        timerNotificacion = 6;
                    } else {
                ...
                case TipoObstaculo::Cometa:
                    ...
                    mensajeNotificacion = "  \x1B[93m★ COMETA! +30 pts +12% combustible ★\x1B[0m  ";
                    timerNotificacion = 5;
                    break;
                case TipoObstaculo::PowerUpEscudo:
                    crearExplosion(it->x, it->y, "\x1B[96m", 12);
                    cantidadEscudos = std::min(5, cantidadEscudos + 1); // Guardar en inventario
                    puntaje += 25;
                    mensajeNotificacion = "  \x1B[96m◈ ESCUDO RECOGIDO! Presiona S para activar ◈\x1B[0m  ";
                    timerNotificacion = 7;
                    break;
                case TipoObstaculo::PowerUpTurbo:
                    crearExplosion(it->x, it->y, "\x1B[93m", 12);
                    cantidadTurbos = std::min(5, cantidadTurbos + 1); // Guardar en inventario
                    puntaje += 25;
                    mensajeNotificacion = "  \x1B[93m◈ TURBO RECOGIDO! Presiona T para activar ◈\x1B[0m  ";
                    timerNotificacion = 7;
                    break;
            }
    ...
    if (combo >= 5) {
        ...
        if (timerNotificacion == 0) {
            mensajeNotificacion = "  \x1B[92m✦ COMBO x" + std::to_string(combo) + "! Bonus activo ✦\x1B[0m  ";
            timerNotificacion = 3;
        }
    }
    ...
    if (combustible <= 20 && combustible > 0 && timerNotificacion == 0) {
        mensajeNotificacion = "  \x1B[91m⚠ COMBUSTIBLE CRITICO! Recoge cometas ⚠\x1B[0m  ";
        timerNotificacion = 4;
    }
...
void Juego::mostrarInformeFinal() const {
    ...
    if (puntaje >= 2000)      { rango = "  S - LEGENDARIO  "; colorRango = "\x1B[93m"; }
    else if (puntaje >= 1200) { rango = "  A - EXCELENTE   "; colorRango = "\x1B[96m"; }
    else if (puntaje >= 700)  { rango = "  B - BIEN HECHO  "; colorRango = "\x1B[92m"; }
    else if (puntaje >= 300)  { rango = "  C - ACEPTABLE   "; colorRango = "\x1B[93m"; }
    else                      { rango = "  D - NECESITAS   ENTRENAR  "; colorRango = "\x1B[91m"; }

    for (int i = 0; i < margenSup; ++i) std::cout << "\n";

    std::cout << pad << "\x1B[96m╔══════════════════════════════════════════════════════════════════════════════════╗\n" << cn;
    std::cout << pad << "\x1B[96m║\x1B[0m" << "                                                                                " << "\x1B[96m║\n" << cn;
    if (vidas > 0) {
        std::cout << pad << "\x1B[96m║\x1B[0m" << "                       \x1B[92m  ★  MISION COMPLETADA  ★  \x1B[0m                         " << "\x1B[96m║\n" << cn;
    } else {
        std::cout << pad << "\x1B[96m║\x1B[0m" << "                       \x1B[91m  ✕  NAVE DESTRUIDA  ✕  \x1B[0m                              " << "\x1B[96m║\n" << cn;
    }
    std::cout << pad << "\x1B[96m║\x1B[0m" << "                                                                                " << "\x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m╠══════════════════════════════════════════════════════════════════════════════════╣\n" << cn;

    // Rango / Calificación
    std::cout << pad << "\x1B[96m║ \x1B[37mRANGO DE MISION:  " << colorRango << "[ " << rango << " ]" << cn << std::string(std::max(0, 39 - (int)rango.size()), ' ') << "\x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m╠══════════════════════════════════════════════════════════════════════════════════╣\n" << cn;

    // Ficha del piloto
    std::cout << pad << "\x1B[96m║ \x1B[90mPILOTO\x1B[0m                                                                         \x1B[96m║\n" << cn;
    auto lineaStat = [&](const std::string &etiq, const std::string &valor, const std::string &color) {
        ...
        std::cout << pad << "\x1B[96m║  \x1B[90m" << etiq << "\x1B[0m" << std::string(espacios, ' ') << color << valor << "  \x1B[96m║\n" << cn;
    };
    ...
    lineaStat("Combustible final:", std::to_string(combustible) + "%", combustible > 50 ? "\x1B[92m" : combustible > 20 ? "\x1B[93m" : "\x1B[91m");
    lineaStat("Tiempo de mision:", std::to_string(tiempoMilisegundos / 1000) + " segundos", "\x1B[95m");
    lineaStat("Combo maximo:", "x" + std::to_string(combo), combo >= 5 ? "\x1B[92m" : "\x1B[37m");
    lineaStat("Escudos restantes:", std::to_string(cantidadEscudos) + " en inventario", "\x1B[96m");
    lineaStat("Turbos restantes:", std::to_string(cantidadTurbos) + " en inventario", "\x1B[93m");

    std::cout << pad << "\x1B[96m╠══════════════════════════════════════════════════════════════════════════════════╣\n" << cn;

    // Trucos y consejos según rango
    if (puntaje < 300) {
        std::cout << pad << "\x1B[96m║ \x1B[93m★\x1B[37m TIP: Recoge cometas para recargar combustible y ganar puntos extra.           \x1B[96m║\n" << cn;
    } else if (puntaje < 700) {
        std::cout << pad << "\x1B[96m║ \x1B[93m★\x1B[37m TIP: Guarda el escudo para situaciones criticas y no lo actives de entrada.   \x1B[96m║\n" << cn;
    } else {
        std::cout << pad << "\x1B[96m║ \x1B[92m★\x1B[37m Excelente trabajo, piloto. El sector necesita a los mejores como tu.         \x1B[96m║\n" << cn;
    }

    std::cout << pad << "\x1B[96m╠══════════════════════════════════════════════════════════════════════════════════╣\n" << cn;
    std::cout << pad << "\x1B[96m║\x1B[0m" << "              \x1B[90mPresiona cualquier tecla para volver al menu...\x1B[0m                   " << "\x1B[96m║\n" << cn;
    std::cout << pad << "\x1B[96m╚══════════════════════════════════════════════════════════════════════════════════╝\n" << cn;
...
void Juego::crearExplosion(int x, int y, const std::string &colorBase, int cantidad) {
    std::default_random_engine generador((unsigned)std::chrono::system_clock::now().time_since_epoch().count());
...
void Juego::actualizarParticulas() {
    ...
    particulas.erase(std::remove_if(particulas.begin(), particulas.end(), [&](const Particula &p) {
        return p.vida <= 0 || p.x < 0 || p.x >= anchoPantalla || p.y < 0 || p.y >= altoPantalla;
    }), particulas.end());
}
